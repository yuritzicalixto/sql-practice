...
VALUES ('PROD005', 'Producto de prueba', 50.0, 100.0, 10, 'imagen.png', TRUE, 1);

-- Prueba Incorrecta
INSERT INTO producto (sku, descripcion, precio_compra, precio_venta, existencia, imagen, estado, id_categoria)
VALUES ('PROD006', 'Producto de prueba', 50.0, 100.0, 10, 'imagen.jpg', TRUE, 1);
...
-- Prueba Correcta
INSERT INTO usuario (usuario, contrasena, imagen, tipo, estado)
VALUES ('admin10', 'password123', 'avatar.png', 'Administrador', TRUE);

-- Prueba Incorrecta
INSERT INTO usuario (usuario, contrasena, imagen, tipo, estado)
VALUES ('usuario30', 'password123', 'avatar.png', 'SuperAdmin', TRUE);
